const workAlertMail = (name, title, content, url) => {
      ...
      max-width: 560px;" class="container">
            ...
            <tr>
              ...
              font-family: sans-serif;" class="paragraph">
                Hi ${name},<br> We like to inform you that, your workplace nearby River <b> ${content.label} </b> and Nearby Station ${content.stationName}
                 has High Alert! <br>
