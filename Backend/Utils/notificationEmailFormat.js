const notificationEmailFormat = (name, title, content, url) => {
      ...
      max-width: 560px;" class="container">
            ...
            <tr>
              ...
              font-family: sans-serif;" class="paragraph">
                Hi ${name},<br> We like to inform you that in <b> ${
    content.label
  } </b> following ${content.stations.length > 1 ? "stations" : "station"} 
                ${content.stations
                  .map(
                    (station) => `<li>
                  ${station}
...
module.exports = notificationEmailFormat;
